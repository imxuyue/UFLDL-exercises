...
features_in = load('STL10Features.mat');

optTheta =  features_in.optTheta;
ZCAWhite =  features_in.ZCAWhite;
meanPatch = features_in.meanPatch;
...
% Add the path to your softmax solution, if necessary
 ...
 addpath softmax_exercise/minFunc/
